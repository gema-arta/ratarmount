...
# Version 0.6.0 built on 2020-07-xx
 ...
 - Fix number of hardlinks being always shown as 2. Changed to show 1. Contribution by Ryan Hitchman.
 - Fix wrong size reporting when index size has changed. Contribution by Ryan Hitchman.
 - Fix blocksize and therefore `du` results always showing 0. Contribution by Ryan Hitchman.
